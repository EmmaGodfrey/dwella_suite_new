                            ...
                            <div className="form-group w-100">
                                <div className="Typeahead Typeahead--twitterUsers">
                                    <div className="search-bg" >
                                        ...
                                        <Input className={`form-control-plaintext searchIcon ${openResp ? 'open' : ''}`} type="text" placeholder="Search here" value={searchValue} onChange={(e) => handleSearchKeyword(e.target.value)} />
                                    </div>
