<template>
  <div class="row">
    <div class="col-xl-6 col-lg-8 xl-70 box-col-8">
      ...
      <div class="d-flex info-block">
        ...
        <div class="flex-grow-1">
          ...
          <a href="javascript:void(0)">Kohoeducation.info/</a>
      ...
      <div class="d-flex info-block">
        ...
        <div class="flex-grow-1">
          <h6>Enzo introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching.</h6>
          <a href="javascript:void(0)">Enzoeducation.info/</a>
      ...
      <div class="d-flex info-block">
        ...
        <div class="flex-grow-1">
          <h6>Enzo Admin Dashboard Template</h6>
          <a href="javascript:void(0)">https://themeforest.net/</a>
          <p>Enzo introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching, GMAT Coaching, SAT Coaching in Surat.</p>
          <div class="star-ratings">
            <ul class="search-info">
              <li>2.5 stars</li>
      ...
      <div class="d-flex info-block">
        ...
        <div class="flex-grow-1">
          ...
          <a href="javascript:void(0)">Tivoeducation.info/</a>
    ...
    <div class="col-xl-6 col-lg-4 xl-30 box-col-30">
