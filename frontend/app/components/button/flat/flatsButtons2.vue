<template>
  <div class="card" id="custom-state-button">
    ...
    <div class="card-body btn-showcase">
      <a class="btn btn-primary" href="javascript:void(0)" title="btn btn-square btn-primary" role="button">Link</a>
      <input class="btn btn-square btn-secondary" type="button" value="Input" title="btn btn-secondary" />
      <input class="btn btn-square btn-success" type="submit" value="Submit" title="btn btn-success" />
  ...
  <div class="card" id="outline-button">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
  <div class="card" id="outline-bold-button">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square" :class="item.classes" v-for="(item, index) in data1" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
  <div class="card" id="outline-large-button">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square btn-lg" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
  <div class="card" id="outline-small-button">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square btn-sm" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
  <div class="card" id="ex-outline-small-button">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square btn-xs" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
  <div class="card">
    <div class="card-header pb-0">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square disabled" :class="item.classes" v-for="(item, index) in data" :key="index" type="button">Disabled</button>
    </div>
  </div>
  <div class="card" id="gradiant">
    ...
    <div class="card-body btn-showcase">
      <button class="btn btn-square" :class="item.classes" v-for="(item, index) in data2" :key="index" type="button">{{ item.title }}</button>
    </div>
  </div>
</template>
...
const { color, outline, gradien } = storeToRefs(store);
const data = color.value;
const data1 = outline.value;
const data2 = gradien.value;
</script>
