        ...
        <section class="cd-container" id="cd-timeline">
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              ...
              <p class="m-0">
                Make sure you pick out a good luck new job card to go with the words, and pop a beautiful bunch of flowers from our gift range in your basket, to make them feel super special.
              </p>
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              ...
              <div class="embed-responsive embed-responsive-21by9 ratio ratio-21x9 m-t-20">
                <iframe src="https://www.youtube.com/embed/wpmHZspl4EM"></iframe>
              </div>
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              ...
              <img class="img-fluid p-t-20" src="/images/banner/1.jpg" alt="" /><span class="cd-date">Jan 24</span>
            </div>
          </div>
          <div class="cd-timeline-block">
          ...
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              <h4>5. Team Work</h4>
              <img class="img-fluid p-t-20" src="/images/banner/3.jpg" alt="" /><span class="cd-date">Feb 18</span>
            </div>
          </div>
          <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
              <h4>Final Testing</h4>
              <p class="m-0">Explain any new understanding or fresh insights about the problem. This is the content of the Final Testing.</p>
