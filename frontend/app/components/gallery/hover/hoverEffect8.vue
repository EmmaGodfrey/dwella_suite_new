    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header pb-0">
          <h4>Hover Effect <span>8</span></h4>
        </div>
        <div class="card-body">
          <div class="row gallery my-gallery" id="aniimated-thumbnials7" itemscope>
            <figure class="col-md-3 col-6 img-hover hover-8" v-for="(n, index) in masonryItems" :key="index" @click="() => showImg(index)" itemprop="associatedMedia" itemscope>
              <a>
                <div>
