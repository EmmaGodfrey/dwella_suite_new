            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="media p-20">
                    <div class="radio radio-primary me-3">
                      <input id="radio19" type="radio" name="radio1" value="1" />
                ...
                <div class="card">
                  <div class="media p-20">
                    <div class="radio radio-secondary me-3">
                      <input id="radio20" type="radio" name="radio1" value="2" />
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="media p-20">
                    <div class="radio radio-secondary me-3">
                      <input id="radio21" type="radio" name="radio1" value="2" />
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="media p-20">
                    <div class="radio radio-primary me-3">
                      <input id="radio22" type="radio" name="radio1" value="4" />
