  ...
  <div class="col-sm-12 col-xl-12 col-xxl-6">
    <div class="card">
      <div class="card-header pb-0">
        ...
        <span>By adding <code>.offer-style</code> class to .mega-inline You can archive this style</span>
      </div>
              ...
              <div class="card">
                <div class="media p-20">
                  <div class="radio radio-primary me-3">
                    <input id="radio17" type="radio" name="radio1" value="1" />
              ...
              <div class="card">
                <div class="media p-20">
                  <div class="radio radio-secondary me-3">
                    <input id="radio18" type="radio" name="radio1" value="2" />
