<template>
  <div class="card">
    <FormsForemcontrolsValidationCustomHeader />
    <div class="card-body">
        ...
        <div class="row g-3">
          <div class="col-md-4">
            ...
            <input
              type="text"
              class="form-control"
              v-bind:class="formSubmitted ? (inputs.firstname.errorMessage.length ? 'is-invalid' : 'is-valid') : ''"
              id="name"
          ...
          <div class="col-md-4">
            ...
            <input
              class="form-control"
              type="text"
              v-bind:class="formSubmitted ? (inputs.lastname.errorMessage.length ? 'is-invalid' : 'is-valid') : ''"
              id="name"
              placeholder="Your name"
          ...
          <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              ...
              <input
                ...
                type="text"
                v-bind:class="formSubmitted ? (inputs.username.errorMessage.length ? 'is-invalid' : 'is-valid') : ''"
                placeholder="Username"
                v-model="inputs.username.data"
              />
        ...
        <div class="row g-3">
          <div class="col-md-6">
            ...
            <input
              ...
              type="text"
              v-bind:class="formSubmitted ? (inputs.city.errorMessage.length ? 'is-invalid' : 'is-valid') : ''"
              placeholder="City"
              required
              v-model="inputs.city.data"
            />
          ...
          <div class="col-md-3 mb-3">
            ...
            <input
              ...
              type="text"
              v-bind:class="formSubmitted ? (inputs.zip.errorMessage.length ? 'is-invalid' : 'is-valid') : ''"
              v-model="inputs.zip.data"
              placeholder="Zip"
              required
            />
...
import { onCustomStyleSubmit, inputs, formSubmitted, optionValues } from '~/composables/commen/validationForm';
</script>
