      ...
      <div class="card-body">
        <div class="clipboaard-container">
          ...
          <h6 class="border rounded card-body f-w-300">
            Lorem ipsum <span class="bg-primary text-white p-1" id="highlighted_paragraph">dolor sit amet</span>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
            magna aliqua.
          </h6>
          <div class="mt-3 text-end">
            <button
              ...
              type="button"
              @click="copyHighlightedParagraphInput('highlighted_paragraph')"
              data-clipboard-action="copy"
              data-clipboard-target="#clipboardExample4"
            >
...
function copyHighlightedParagraphInput(elementId: string) {
