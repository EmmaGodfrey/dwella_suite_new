<template>
  <div class="modal fade modal-bookmark" id="taskmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-bookmark needs-validation" id="bookmark-form" novalidate @submit.prevent="onCustomStyleSubmit">
            <div class="form-row">
              <div class="form-group col-md-12">
                <label for="task-title">Task Title</label>
                <input class="form-control" id="task-title" type="text" required autocomplete="off" :class="formSubmitted ? (titleError ? 'is-invalid' : 'is-valid') : ''" v-model="title" />
              </div>
              <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                <div class="d-flex date-details">
                  ...
                  <div class="d-inline-block">
                    <input class="datepicker-here form-control digits" type="text" data-language="en" placeholder="Date" v-bind:class="formSubmitted ? (dateError ? 'is-invalid' : 'is-valid') : ''" />
                  </div>
                  <div class="d-inline-block">
                    <select class="form-control" v-bind:class="formSubmitted ? (selectError ? 'is-invalid' : 'is-valid') : ''">
                      <option v-for="(value, index) in optionValues" :value="value" :key="value + index">{{ value }} am</option>
                    </select>
                  </div>
                  <div class="d-inline-block">
              ...
              <div class="form-group col-md-12 my-0">
                <textarea class="form-control" required autocomplete="off" v-bind:class="formSubmitted ? (descError ? 'is-invalid' : 'is-valid') : ''" v-model="desc"></textarea>
              </div>
            </div>
            <input id="index_var" type="hidden" value="6" />
            <button class="btn btn-secondary" id="Bookmark" type="submit" @click="save()" data-bs-dismiss="modal">Save</button>
...
const selectError = ref<boolean>(false);
