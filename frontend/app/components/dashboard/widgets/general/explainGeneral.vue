      ...
      <div class="calender-widget">
        ...
        <div class="cal-desc text-center card-body">
          ...
          <p class="custom-scrollbar">
            We are excited about continuing to build a complete ecosystem around value commerce, where we can serve Bharat consumers their shopping journey. Our mission is to become India’s value
            lifestyle leader.
          </p>
        </div>
      </div>
